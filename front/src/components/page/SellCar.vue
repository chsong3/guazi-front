               ...
               <el-col>
                   ...
                   <el-row  style="height:600px;background: blue">
                       <div class="s_search" style="border: crimson solid 2px">
                           <!--标题-->
                           <div class="Title" style="margin-top:70px;margin-left:350px;width: 1000px">
                               <h1 style="color: white;font-size: 60px">瓜子二手车&nbsp;&nbsp;&nbsp;&nbsp;二手车行业领军者</h1>
                           </div>
                           <!--输入框-->
                           <div class="sell_input" style="margin-left: 250px;margin-top:50px;width:1000px;">
                   ...
                   <el-row>
                       <el-col>
                           <div class="sell_process">
                               <!--标题-->
                               <div style="margin-left: 400px;margin-top: 30px;width: 400px;">
                   ...
                   <el-row style="height:900px;background: white">
                       <div class="deal_Car" style="margin-top: 400px;margin-left:240px;width: 1200px;height: 400px;">
                           <h1 style="margin-left: 450px;">最近成交</h1>
                           <!--标题底部横线-->
                           <div style="margin-left: 500px;width: 30px;border-bottom: green solid 3px"/>
                           <!--图片浏览框-->
                   ...
                   <el-row style="height:600px;background: gainsboro">
                       <div class="car_question" style="margin-left:350px;width: 1200px;height: 400px;">
                           <h1 style="margin-left: 350px;">瓜子问答</h1>
                           <!--标题底部横线-->
                           <div style="margin-left: 400px;width: 30px;border-bottom: green solid 3px"/>
                           <!--问题部分-->
                           <div style="margin-left: -200px;margin-top:130px;width: 1300px;height: 300px">
                               <el-col :span="8">
